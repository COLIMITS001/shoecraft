...
export const categories = ["Headphones", "Speakers", "Watch", "s", "Mouse", "Decoration"];
...
export const productDummyData = [
    ...
    {
        id: "prod_9",
        name: "Apple Wireless s",
        description: "Apple Wireless s with a sleek design. It's perfect for any room. It's made of high-quality materials and comes with a lifetime warranty.",
        mrp: 89,
        price: 29,
        images: [product_img9],
        storeId: "seller_1",
