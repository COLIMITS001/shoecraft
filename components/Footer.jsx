...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+254704448259", path: '/', icon: MailIcon },
                { text: "collshenr.com", path: '/', icon: PhoneIcon },
                { text: "Nairobi 00100", path: '/', icon: MapPinIcon }
            ]
        }
    ];
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © shoecraft All Right Reserved.
                </p>
            </div>
        </footer>
    );
